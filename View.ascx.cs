...
using Connect.DNN.Modules.Map.Components;
...
namespace Connect.DNN.Modules.Map
{
    ...
    /// 
    /// Because the control inherits from MapModuleBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// 
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class View : MapModuleBase, IActionable
    {

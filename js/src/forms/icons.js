...
var Icon = React.createClass({
  ...
  render: function() {
    switch(this.props.type) {
      ...
      case 'circle_error': 
        return (
          <svg viewBox="0 0 20 20" className="circle_error">
      ...
      case 'circle_tick':
        return (
          <svg viewBox="0 0 23 23" className="circle_tick">
      ...
      case 'circle_tick_filled':
        return (
          <svg viewBox="0 0 20 20" className="circle_tick_filled">
      ...
      case 'guthub': 
        return (
          <svg viewBox="0 0 34 34" className="guthub">
